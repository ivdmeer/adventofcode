...
public class LanternfishSimulatorTest {
	...
	void exampleDay1Test() {
		...
		LaternfishSimulator laternfishSimulator = new LaternfishSimulator(parseSimulationValue(strings.get(0)));
		String simulationValue = laternfishSimulator.simulateDay(1);
	...
	void exampleDay2Test() {
		...
		LaternfishSimulator laternfishSimulator = new LaternfishSimulator(parseSimulationValue(strings.get(0)));
		String simulationValue = laternfishSimulator.simulateDay(2);
	...
	void exampleDay12Test() {
		...
		LaternfishSimulator laternfishSimulator = new LaternfishSimulator(parseSimulationValue(strings.get(0)));
		String simulationValue = laternfishSimulator.simulateDay(12);
	...
	void exampleDay18Test() {
		...
		LaternfishSimulator laternfishSimulator = new LaternfishSimulator(parseSimulationValue(strings.get(0)));
		String simulationValue = laternfishSimulator.simulateDay(18);

		Assertions.assertEquals("6,0,6,4,5,6,0,1,1,2,6,0,1,1,1,2,2,3,3,4,6,7,8,8,8,8", simulationValue);
		Assertions.assertEquals(26, laternfishSimulator.getFishCount());
	}
	...
	void exampleDay80Test() {
		...
		LaternfishSimulator laternfishSimulator = new LaternfishSimulator(parseSimulationValue(strings.get(0)));
		laternfishSimulator.simulateDay(80);

		Assertions.assertEquals(5934, laternfishSimulator.getFishCount());
	}
	...
	void exerciseTest() {
		...
		LaternfishSimulator laternfishSimulator = new LaternfishSimulator(strings.get(0));
		laternfishSimulator.simulateDay(80);

		Assertions.assertEquals(388739, laternfishSimulator.getFishCount());
	}
